! function(a, b, c) {
    ...
    d.utils.init = function() {
        ...
        d.cache.videoImage = d.cache.video.find("#poster"), d.cache.videoImage.attr("src", d.cache.videoImage.data("video")), d.cache.videoImage.css("width", "auto"), d.cache.videoImage.addClass("hidden"), d.cache.videoImage.load(function() {
        ...
        d.cache.body.find(".shadeOverlay", d.cache.body).each(function() {
            var c = $(this);
            c.css("opacity", 0), d.cache.window.on("scroll onscroll", {
                $elem: c,
                maxOpacity: a,
                windowHeight: b
